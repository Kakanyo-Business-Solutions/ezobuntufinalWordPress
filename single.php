        ...
        while(have_posts()) : the_post(); ?>
            ...
            <div class="nicdark_section">
                ...
                <?php $args = array(
                    ...
                    'nextpagelink'     => esc_html__('Next page', 'sweetcake'),
                    'previouspagelink' => esc_html__('Previous page', 'sweetcake'),
                    'pagelink'         => '%',
                    'echo'             => 1
                ); ?>
                ...
                <?php 
                    esc_html_e('Categories : ','sweetcake');
                    the_category();
                ?>
                </div>
                <!--END categories-->
