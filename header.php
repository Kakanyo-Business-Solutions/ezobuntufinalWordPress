    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <?php
            ...
            <div class="nicdark_grid_12 nicdark_padding_top_50 nicdark_padding_botttom_50 nicdark_text_align_center_responsive nicdark_text_align_center">
                ...
                <a href="<?php echo esc_url(home_url()); ?>"><h3 class=" nicdark_font_size_50"><?php echo esc_html(get_bloginfo( 'name' )); ?></h3></a>
                <div class="nicdark_section nicdark_height_10"></div>
                <a href="<?php echo esc_url(home_url()); ?>"><p class="nicdark_font_size_12 nicdark_letter_spacing_3"><?php echo esc_html(get_bloginfo( 'description' )); ?></p></a>
                <div class="nicdark_section nicdark_height_10"></div>
            </div>
